...
let StandardCharacteristics: [CBUUID: String] = [
    ...
    CBUUID(string: "2A90"): "Last Name",
    CBUUID(string: "2A91"): "Maximum Recommended Heart Rate",
    CBUUID(string: "2A92"): "Resting Heart Rate",
    CBUUID(string: "2A93"): "Sport Type for Aerobic and Anaerobic Thresholds",
    CBUUID(string: "2A94"): "Three zone Heart Rate Limits",
    CBUUID(string: "2A95"): "Two Zone Heart Rate Limit",
    CBUUID(string: "2A96"): "VO2 Limit",
    CBUUID(string: "2A97"): "Waist Circumference",
    CBUUID(string: "2A98"): "Weight",
    CBUUID(string: "2A99"): "Database Change Increment",
    CBUUID(string: "2A9A"): "User Index",
    CBUUID(string: "2A9B"): "Body Composition Feature",
    CBUUID(string: "2A9C"): "Body Composttion Measurement",
    CBUUID(string: "2A9D"): "Weight Measurement",
    CBUUID(string: "2A9E"): "Weight Scale Feature",
    CBUUID(string: "2A9F"): "User Control Point",
    CBUUID(string: "2AA0"): "Magnetic Density Flux - 2D",
    CBUUID(string: "2AA1"): "Magnetic Density Flux - 3D",
    CBUUID(string: "2AA2"): "Language",
    CBUUID(string: "2AA3"): "Barometric Pressure Trend",
    CBUUID(string: "2AA4"): "Bond Management Control Point",
    CBUUID(string: "2AA5"): "Bond Management Feature",
    CBUUID(string: "2AA6"): "Central Address Resolution",
    CBUUID(string: "2AA7"): "CGM Measurement",
    CBUUID(string: "2AA8"): "CGM Feature",
    CBUUID(string: "2AA9"): "CGM Status",
    CBUUID(string: "2AAA"): "CGM Session Start Time",
    CBUUID(string: "2AAB"): "CGM Session Run Time",
    CBUUID(string: "2AAC"): "CGM Specific Ops Control Point",
    CBUUID(string: "2AAD"): "Indoor Positiion Configuration",
    CBUUID(string: "2AAE"): "Latitude",
    CBUUID(string: "2AAF"): "Longitude",
    CBUUID(string: "2AB0"): "Local North Coordinate",
    CBUUID(string: "2AB1"): "Local East Coordinate",
    CBUUID(string: "2AB2"): "Floor Number",
    CBUUID(string: "2AB3"): "Altitude",
    CBUUID(string: "2AB4"): "Uncertainty",
    CBUUID(string: "2AB5"): "Location Name",
    CBUUID(string: "2AB6"): "URI",
    CBUUID(string: "2AB7"): "HTTP Headers",
    CBUUID(string: "2AB8"): "HTTP Status Code",
    CBUUID(string: "2AB9"): "HTTP Entity Body",
    CBUUID(string: "2ABA"): "HTTP Control Point",
    CBUUID(string: "2ABB"): "HTTPS Security",
    CBUUID(string: "2ABC"): "TDS Control Point",
    CBUUID(string: "2ABD"): "OTS Feature",
    CBUUID(string: "2ABE"): "Object Name",
    CBUUID(string: "2ABF"): "Object Type",
    CBUUID(string: "2AC0"): "Object Size",
    CBUUID(string: "2AC1"): "Object First-Created",
    CBUUID(string: "2AC2"): "Object Last-Modified",
    CBUUID(string: "2AC3"): "Object ID",
    CBUUID(string: "2AC4"): "Object Properties",
    CBUUID(string: "2AC5"): "Object Action Control Point",
    CBUUID(string: "2AC6"): "Object List Control Point",
    CBUUID(string: "2AC7"): "Object List Filter",
    CBUUID(string: "2AC8"): "Object Changed",
    CBUUID(string: "EE1D"): "Fitness Machine Control Point",
]
